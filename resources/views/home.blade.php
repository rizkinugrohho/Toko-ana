...
<section class="text-gray-600 body-font">
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Selamat Datang di Toko Ana Ceria Kami</h1>
            <p class="mb-8 leading-relaxed">Kami menyediakan berbagai macam biji kopi berkualitas tinggi dengan harga terjangkau. Dari berbagai jenis daerah, temukan semua sini.</p>
